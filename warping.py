...
class ImageBlobWarping(object):
    ...
    def corners(self):
        return (
            (
                self.__blob.topLeftCorner()[0] - self.__cropX,
                self.__blob.topLeftCorner()[1] - self.__cropY
            ),
            (
                self.__blob.topRightCorner()[0] - self.__cropX,
                self.__blob.topRightCorner()[1] - self.__cropY
            ),
            (
                self.__blob.bottomRightCorner()[0] - self.__cropX,
                self.__blob.bottomRightCorner()[1] - self.__cropY
            ),
            (
                self.__blob.bottomLeftCorner()[0] - self.__cropX,
                self.__blob.bottomLeftCorner()[1] - self.__cropY
            )
        )
